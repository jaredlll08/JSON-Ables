...
public class ResourcePackAssembler
{
    ...
    public ResourcePackAssembler assemble()
    {
        ...
        try
        {
            ...
            if (hasPackPng)
            {
            	jsonAbles.api.utils.FileUtils.copyFromJar(jarClass, modid + "/" + "pack.png", new File(dir.getAbsolutePath() + "/pack.png"));
            }
            ...
            jsonAbles.api.utils.FileUtils.zipFolderContents(dir, zip);
            dir.delete();
        }
        catch (IOException e)
        {
