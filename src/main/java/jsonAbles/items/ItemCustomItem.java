...
public class ItemCustomItem extends Item {
	...
	public ItemCustomItem(CreativeTabs creativeTab, int lifeSpan, String unlocalizedName, String useAction, String[] lore, boolean loreFormat, boolean hasRenderColor, int renderColor, boolean render3dItem, int maxStackSize, String textureName) {
