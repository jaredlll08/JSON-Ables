...
public class RenderSolarGenerator extends TileEntitySpecialRenderer {
	...
	private LightRedirectionCube model = new LightRedirectionCube();
	...
	public void renderTileEntityAt(TileEntity var1, double var2, double var4, double var6, float var8) {
		if (var1 instanceof TileEntitySolarGenerator)
			renderLight((TileEntitySolarGenerator) var1, var2, var4, var6);
	}

	public void renderLight(TileEntitySolarGenerator tile, double x, double y, double z) {
		GL11.glPushMatrix();
		...
		mc.renderEngine.bindTexture(new ResourceLocation(ModProps.modid + ":textures/models/LightRedirectionCube.png"));
		model.render(size);
