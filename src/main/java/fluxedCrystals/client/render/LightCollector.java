...
/**
 * LightCollector - Drullkus
 * Created using Tabula 4.1.1
 */
public class LightCollector extends ModelBase {
    ...
    public LightCollector() {
        ...
        this.Vert1_4 = new ModelRenderer(this, 0, 27);
        this.Vert1_4.setRotationPoint(0.0F, 16.0F, 0.0F);
        this.Vert1_4.addBox(3.5F, -6.0F, -7.0F, 1, 12, 2, 0.0F);
        ...
        this.Lens2.addBox(-8.0F, 11.0F, -8.0F, 16, 2, 16, 0.0F);
        ...
        this.Hort2_1 = new ModelRenderer(this, 0, 27);
        this.Hort2_1.setRotationPoint(0.0F, 16.0F, 0.0F);
        this.Hort2_1.addBox(-4.5F, -6.0F, -7.0F, 1, 12, 2, 0.0F);
        this.setRotateAngle(Hort2_1, 0.0F, 1.5707963267948966F, 1.5707963267948966F);
        this.Vert2_4 = new ModelRenderer(this, 0, 27);
        this.Vert2_4.setRotationPoint(0.0F, 16.0F, 0.0F);
        this.Vert2_4.addBox(-4.5F, -6.0F, -7.0F, 1, 12, 2, 0.0F);
        ...
        this.Hort1_1 = new ModelRenderer(this, 0, 27);
        this.Hort1_1.setRotationPoint(0.0F, 16.0F, 0.0F);
        this.Hort1_1.addBox(3.5F, -6.0F, -7.0F, 1, 12, 2, 0.0F);
